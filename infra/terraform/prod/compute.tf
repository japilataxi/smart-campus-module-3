...
resource "aws_instance" "auth" {
  ...
  user_data = templatefile("${path.module}/templates/auth-user-data.sh.tpl", {
    compose_content = file("${path.module}/../../docker/docker-compose.auth.prod.yml")
  })
...
resource "aws_instance" "library" {
  ...
  user_data = templatefile("${path.module}/templates/library-user-data.sh.tpl", {
    compose_content = file("${path.module}/../../docker/docker-compose.library.prod.yml")
  })
...
resource "aws_instance" "incident" {
  ...
  user_data = templatefile("${path.module}/templates/incident-user-data.sh.tpl", {
    compose_content = file("${path.module}/../../docker/docker-compose.incident.prod.yml")
  })
